import unittest
from src.kmeans_algorithm_assignment import get_k_means


class TestKmeansAlgorithmAssignment(unittest.TestCase):
    ...
    def test_kmeans1(self):
        ...
        self.assertEqual(get_k_means(test_data_1, 4, 1), [
                         [-1.63, -1.703, -1.515, -1.608]])
        self.assertEqual(get_k_means(test_data_1, 4, 2), [
                         [-1.356, -1.87, -1.948, -2.092], [-1.813, -1.592, -1.226, -1.286]])
        self.assertEqual(get_k_means(test_data_1, 4, 3), [
    ...
    def test_kmeans2(self):
        ...
        self.assertEqual(get_k_means(test_data_2, 4, 1), [
                         [8.34, 178.6, 72.8, 25.5]])
        self.assertEqual(get_k_means(test_data_2, 4, 2), [
                         [9.733, 244.667, 72.0, 30.5], [6.25, 79.5, 74.0, 18.0]])
        self.assertEqual(get_k_means(test_data_2, 4, 3), [
    ...
    def test_Kmeans(self):
        ...
        self.assertEqual(get_k_means(test_data_3, 6, 1), [
                         [13.747, 1.893, 2.347, 16.433, 106.5, 3.018]])
        self.assertEqual(get_k_means(test_data_3, 6, 2), [
                         [13.89, 2.167, 2.51, 18.467, 117.333, 3.083], [13.603, 1.62, 2.183, 14.4, 95.667, 2.953]])
        self.assertEqual(get_k_means(test_data_3, 6, 3), [[13.805, 1.54, 2.205, 16.0, 93.5, 3.105], [
